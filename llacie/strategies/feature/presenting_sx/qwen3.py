...
class QwenStrategy(AbstractVllmOrLcpStrategy):
    """\
    Attempts to extract the `presenting_sx` feature using Qwen3 4B
    """


    task=PresentingSymptomsFeatureTask
    name="feature.presenting_sx.qwen3_4b"
    version = "0.0.1"
    prereq_tasks = []
    ...
    GGUF_MODEL_FILENAME = 'Qwen3-4B-Q8_0.gguf'
