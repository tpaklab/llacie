...
from ..inference.uci_health_server import U
from ..inference.llama_cpp_python import LlamaCppPython
from ..utils import echo_warn, echo_info, strtobool

class RemoteServer(AbstractStrategy):
    """
    Meant to work with the UCI Health server individually with no separate components
    """
    ...
    NICE_MODEL_NAME = "Failed Scenario"
    ...
    def __init__(self, db, config, **options):
        ...
        self.backend = "uci_health_server"
